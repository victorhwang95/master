...
@objc public class PermissionScope: UIViewController, CLLocationManagerDelegate, UIGestureRecognizerDelegate, CBPeripheralManagerDelegate {
    ...
    */
    public func requestLocationAlways(onTapped tapped: ((Bool) -> Void)?) {
        ...
        case .unauthorized:
            self.showDeniedAlert(.locationAlways, message: "Vaster requires your current location to recommend the best advisors", onTapped: {(isTapped) -> () in
                tapped?(isTapped)
            })
        case .disabled:
            self.showDisabledAlert(.locationInUse, message: "Vaster requires your current location to recommend the best advisors")
        default:
            break
        }
    }
    ...
    */
    public func requestLocationInUse(onTapped tapped: ((Bool) -> Void)?) {
        ...
        case .unauthorized:
            self.showDeniedAlert(.locationInUse, message: "Vaster requires your current location to recommend the best advisors", onTapped: {(isTapped) -> () in
                tapped?(isTapped)
            })
        case .disabled:
            self.showDisabledAlert(.locationInUse, message: "Vaster requires your current location to recommend the best advisors")
    ...
    */
    public func requestContacts() {
        ...
        case .unauthorized:
            self.showDeniedAlert(.contacts, message: nil, onTapped: nil)
        default:
            break
        }
    }
        ...
        DispatchQueue.main.asyncAfter(
            ...
            self.getResultsForConfig { results in
                ...
                if notificationResult.status == .unknown {
                    self.showDeniedAlert(notificationResult.type, message: nil, onTapped: nil)
                } else {
                    self.detectAndCallback()
                }
            }
    ...
    */
    public func requestNotifications() {
        ...
        case .unauthorized:
            showDeniedAlert(.notifications, message: nil, onTapped: nil)
        case .disabled:
            showDisabledAlert(.notifications, message: nil)
        case .authorized:
            detectAndCallback()
        }
    }
    ...
    */
    public func requestMicrophone(onTapped tapped: ((Bool) -> Void)?) {
        ...
        case .unauthorized:
            showDeniedAlert(.microphone, message: nil, onTapped: {(isTapped) -> () in
                tapped?(isTapped)
            })
        case .disabled:
            showDisabledAlert(.microphone, message: nil)
        case .authorized:
            break
        }
    }
    ...
    */
    public func requestCamera(onTapped tapped: ((Bool) -> Void)?) {
        ...
        case .unauthorized:
            showDeniedAlert(.camera, message: nil, onTapped: {(isTapped) -> () in
                tapped?(isTapped)
                })
        case .disabled:
            showDisabledAlert(.camera, message: nil)
        case .authorized:
            break
        }
    }
    ...
    */
    public func requestPhotos(onTapped tapped: ((Bool) -> Void)?) {
        ...
        case .unauthorized:
            self.showDeniedAlert(.photos, message: nil, onTapped: {(isTapped) -> () in
                tapped?(isTapped)
            })
        case .disabled:
            showDisabledAlert(.photos, message: nil)
        case .authorized:
            break
        }
    }
    ...
    */
    public func requestReminders() {
        ...
        case .unauthorized:
            self.showDeniedAlert(.reminders, message: nil, onTapped: nil)
        default:
            break
        }
    }
    ...
    */
    public func requestEvents() {
        ...
        case .unauthorized:
            self.showDeniedAlert(.events, message: nil, onTapped: nil)
        default:
            break
        }
    }
    ...
    */
    public func requestBluetooth() {
        ...
        switch status {
        case .disabled:
            showDisabledAlert(.bluetooth, message: nil)
        case .unauthorized:
            showDeniedAlert(.bluetooth, message: nil, onTapped: nil)
        case .unknown:
            triggerBluetoothStatusUpdate()
        default:
            break
    ...
    */
    public func requestMotion() {
        ...
        switch status {
        case .unauthorized:
            showDeniedAlert(.motion, message: nil, onTapped: nil)
        case .unknown:
            triggerMotionStatusUpdate()
        default:
            break
    ...
    */
    func showDeniedAlert(_ permission: PermissionType, message: String?, onTapped tapped: ((Bool) -> Void)?) {
        ...
        if let message = message {
            ...
            msgContent = "Please enable access to \(permission.prettyDescription) in the Settings app".localized
        }
        let alert = UIAlertController(title: "\(permission.prettyDescription) Permissions".localized,
                                      message: msgContent,
    ...
    - parameter permission: Permission type.
    */
    func showDisabledAlert(_ permission: PermissionType, message: String?) {
        // compile the results and pass them back if necessary
        if let onDisabledOrDenied = self.onDisabledOrDenied {
            self.getResultsForConfig({ results in
                onDisabledOrDenied(results)
        ...
        if let message = message {
            ...
            msgContent = "Please enable access to \(permission.prettyDescription) in Settings".localized
        }
